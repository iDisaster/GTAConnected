void main()
{
    ...
    sub_811( 1 );
    sub_3934( ref l_U76._fU0, 1, 0 );
    while (NOT g_U783._fU16)
    {
        WAIT( 0 );
        if (sub_4259( ref l_U75 ))
        {
            sub_811( 0 );
            sub_3934( ref l_U76._fU0, 1, 1 );
        }
        if (g_U777._fU12 != -1)
        {
            sub_4388( ref g_U757, "www.publiclibertyonline.com", g_U777._fU12, -1, -1 );
            g_U756 = 1;
        }
    }
    g_U783._fU16 = 0;
...
int sub_69(unknown uParam0, unknown uParam1)
{
    ...
    for ( I = 1; I <= (g_U1378 - 1); I++ )
    {
        if (IS_BIT_SET( g_U1378[I], 21 ))
        {
            (uParam1^)[GET_BITS_IN_RANGE( g_U1378[I], 22, 31 )] = I;
            (uParam1^)[0]++;
        }
    }
    sub_214( uParam0, uParam1 );
    for ( I = 1; I <= (g_U1378 - 2); I++ )
    {
        if ((uParam1^)[I] == -1)
        {
            for ( J = I + 1; J <= (g_U1378 - 1); J++ )
            {
                if ((uParam1^)[J] != -1)
                {
                    (uParam1^)[I] = (uParam1^)[J];
...
void sub_811(unknown uParam0)
{
    ...
    sub_1857( ref l_U65, "advert_medium_0", 3, 0 );
    if (NOT (sub_2651( 2, ref l_U64, l_U0, 6, 1 )))
    {
        sub_1857( ref l_U64, "quick_link_table", 3, 1 );
    }
    return;
}
...
void sub_1857(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    char[16] cVar6;
    unknown uVar10;
    ...
    ConcatString(ref cVar6, g_U873[uParam3], 16);
    ADD_TO_HTML_SCRIPT_OBJECT( (uParam0^), "<a href="" );
    ...
    ADD_TO_HTML_SCRIPT_OBJECT( (uParam0^), "">" );
    string(ref cVar6, g_U873[uParam3], 16);
    switch (uParam2)
    {
        case 0:
...
int sub_2651(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4)
{
    int I;
    int iVar8;
    int iVar9;
    ...
    {
        case 0:
        sub_2794( uParam1, "titAlso.jpg", -1, 88, 28 );
    ...
    for ( I = 48; I >= 1; I += -1 )
    {
        if (uVar11[I] != -1)
        {
            if ((uVar11[I] == iVar9) || (bVar10))
            {
                if (bVar10)
                {
                    sub_3196( uParam0, uParam1, uVar11[I], -1, ref iVar8, uParam4, iParam3 );
                    sub_3740( "\n adding other stories" );
                }
                else
                {
                    sub_3196( uParam0, uParam1, uVar11[I], iParam2 / 100, ref iVar8, uParam4, iParam3 );
...
void sub_2731(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_2794(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
    char[16] cVar7;
...
void sub_3196(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4, unknown uParam5, int iParam6)
{
    char[16] cVar9;
    unknown uVar13;
    unknown uVar14;
    ...
    if (((uParam4^) < iParam6) AND (iParam3 != 0))
    {
        ...
        {
            sub_3341( uParam0, uParam1, uParam5 );
...
void sub_3341(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
        switch (uParam0)
        {
            case 0:
            sub_2794( uParam1, "arrowBlack.jpg", -1, 16, 16 );
            break;
            case 2:
            sub_2794( uParam1, "arrow.jpg", -1, 16, 16 );
            break;
        }
    }
    return;
...
void sub_3934(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_3945( uParam1 );
    if (bParam2)
    {
        RELOAD_WEB_PAGE( g_U783._fU4 );
    }
    else
    {
        LOAD_WEB_PAGE( g_U783._fU4, uParam0 );
        StrCopy( ref g_U783._fU168, uParam0, 64 );
        g_U783._fU164 = 1;
    }
    sub_4083();
    return;
...
void sub_3945(boolean bParam0)
{
    ...
    {
        g_U783._fU20 = 0.00000000;
    }
    SET_WEB_PAGE_SCROLL( g_U783._fU4, g_U783._fU20 );
    return;
}
...
void sub_4083()
{
    ...
    fVar2 = GET_WEB_PAGE_HEIGHT( g_U783._fU4 );
    if (fVar2 > (g_U867 - (g_U865 * g_U867)))
    {
        g_U783._fU28 = 1;
        g_U783._fU32 = (1.00000000 - g_U865) / fVar2;
        g_U783._fU36 = (1.00000000 - g_U865) * ((g_U867 - (g_U865 * g_U867)) / fVar2);
    }
    else
    {
        g_U783._fU28 = 0;
...
void sub_4388(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
