                ...
                while (true)
                {
                    ...
                    if (NOT l_U247)
                    {
                        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                        {
                            ...
                            sub_2468();
                            if (sub_2887( ref l_U278, ref l_U380 ))
                            {
                                sub_2951();
                            }
                            if ((sub_3120( ref l_U268 )) || (sub_3212( ref l_U268, 22.00000000 )))
                            {
                                sub_2951();
                            }
                            sub_3398( ref l_U277 );
                            ...
                            else if ((sub_2503( ref l_U268 )) < 7.00000000)
                            {
                                if (NOT g_U64940)
                                {
                                    g_U64940 = 1;
                    ...
                    {
                        sub_3398( ref l_U277 );
                        if (sub_11893( ref l_U271 ))
                        {
                            sub_11944();
                        }
                        if (sub_16941( ref l_U273 ))
                        {
                            sub_11944();
                        }
                        if (l_U264)
                        {
                            if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_2572(), -116.18190000, -230.58100000, 11.74390000, 25.00000000, 25.00000000, 25.00000000, 0 ))) || (sub_17069( ref l_U400, 60000 )))
                            {
                                sub_11944();
                            }
                        }
...
boolean sub_588(unknown uParam0, int iParam1)
{
    ...
    {
        if (sub_909( g_U33969[uVar4]._fU8 ))
        {
...
int sub_2468()
{
    if (l_U246)
    {
        if (IS_HINT_RUNNING())
        {
            if (((sub_2503( ref l_U268 )) > 18.00000000) || (sub_2704()))
            {
...
void sub_2503(unknown uParam0)
{
    ...
    {
        GET_CHAR_COORDINATES( sub_2572(), ref vVar3.x, ref vVar3.y, ref vVar3.z );
...
int sub_2704()
{
    if (IS_CHAR_IN_ANY_CAR( sub_2572() ))
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_2572(), ref l_U275 );
        if (NOT (l_U275 == nil))
        {
...
int sub_2887(unknown uParam0, unknown uParam1)
{
    float fVar4;
...
void sub_2951()
{
    ...
    if (g_U64962 > 1)
    {
        ...
        SAY_AMBIENT_SPEECH( sub_2572(), "MISSION_FAIL_RAGE", 0, 0, 0 );
    }
    sub_1307();
    return;
}

void sub_2964(unknown uParam0)
{
...
int sub_3120(unknown uParam0)
{
    if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
        {
            if (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_2572(), 0 ))
            {
                return 1;
            }
        }
...
int sub_3212(unknown uParam0, float fParam1)
{
    if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
        {
            if ((sub_2503( uParam0 )) < fParam1)
            {
                if (HAS_CHAR_SPOTTED_CHAR( (uParam0^), sub_2572() ))
                {
                    if (IS_CHAR_ARMED( sub_2572(), 7 ))
                    {
...
int sub_3408(unknown uParam0)
{
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_2572() ))
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_2572(), uParam0 );
        if (NOT ((uParam0^) == nil))
        {
    ...
    switch (l_U212)
    {
        ...
        if ((l_U253) AND (NOT l_U252))
        {
            if (((HAS_MODEL_LOADED( l_U388 )) AND (HAS_MODEL_LOADED( l_U196._fU4 ))) AND (HAVE_ANIMS_LOADED( "missjeff3" )))
            {
                ...
                sub_5667( ref l_U268, ref l_U279, 1 );
                SET_CHAR_MONEY( l_U268, 1000 );
                sub_4550( 1, l_U268, "PI_JEFF", 0 );
...
void sub_4279(unknown uParam0, unknown uParam1)
{
    boolean bVar4;
...
void sub_4550(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    sub_4630( "\n PED NUMBER ", uParam0 );
    sub_4670( " ADDED WITH VOICE ", uParam2 );
    return;
}

void sub_4630(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_4670(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_5667(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
...
void sub_6200()
{
    switch (l_U216)
    {
        ...
        if (NOT l_U239)
        {
            if ((sub_2503( ref l_U268 )) < 10.00000000)
            {
                if (NOT (IS_CHAR_INJURED( l_U268 )))
                {
                    sub_6305( "PIJ_SPYING", ref l_U421, 4, 1 );
                    if (IS_CHAR_ON_FOOT( sub_2572() ))
                    {
    ...
    if (IS_CHAR_ON_FOOT( sub_2572() ))
    {
        ...
        {
            case 0:
            GET_OFFSET_FROM_CHAR_IN_WORLD_COORDS( l_U268, g_U64933._fU0, g_U64933._fU4, g_U64933._fU8, ref l_U288._fU0, ref l_U288._fU4, ref l_U288._fU8 );
            GET_OFFSET_FROM_CHAR_IN_WORLD_COORDS( l_U268, g_U64936._fU0, g_U64936._fU4, g_U64936._fU8, ref l_U291._fU0, ref l_U291._fU4, ref l_U291._fU8 );
            if (IS_CHAR_IN_ANGLED_AREA_3D( sub_2572(), l_U288._fU0, l_U288._fU4, l_U288._fU8, l_U291._fU0, l_U291._fU4, l_U291._fU8, 6.00000000, 0 ))
            {
                if (sub_7557())
                {
                    CLEAR_PRINTS();
                    ...
                    GET_CHAR_COORDINATES( sub_2572(), ref l_U282._fU0, ref l_U282._fU4, ref l_U282._fU8 );
                    CLEAR_AREA( l_U282._fU0, l_U282._fU4, l_U282._fU8, 100.00000000, 1 );
                    SET_CHAR_COORDINATES( sub_2572(), -109.13960000, -223.80550000, 13.00000000 );
                    if (NOT (IS_CHAR_INJURED( l_U268 )))
                    {
...
void sub_6305(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    return sub_6326( uParam0, ref l_U4._fU0, uParam1, uParam2, uParam3 );
}

void sub_6326(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    char[16] cVar7;
    char[12] cVar11;
    unknown uVar14;
    ...
    return sub_6380( ref cVar11, uParam2, uParam3, 0, 0, 0, 0, ref cVar7, uParam4 );
}

int sub_6380(unknown uParam0, int iParam1, unknown uParam2, boolean bParam3, boolean bParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8)
{
    int I;
    int iVar12;
...
void sub_6479(unknown uParam0)
{
    return;
}

void sub_7088(int iParam0, int iParam1)
{
    int I;
...
void sub_7652(unknown uParam0, unknown uParam1)
{
    ...
    sub_8015();
    sub_8782( g_U33969[uVar4]._fU32 );
    g_U33969[uVar4]._fU32 = 0;
    sub_8926( uParam0, uParam1 );
    g_U10899 = 1;
    return;
}
...
int sub_8214(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    switch (uParam0)
    {
        case 0:
...
void sub_8926(unknown uParam0, int iParam1)
{
    char[16] cVar4;
    int iVar8;
...
void sub_9772(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
...
void sub_10589()
{
    ...
    sub_4550( 2, l_U271, "JEFF_KILLER", 0 );
    if (NOT (IS_CHAR_INJURED( l_U268 )))
    {
        SET_CHAR_COORDINATES( sub_2572(), -108.61180000, -223.38750000, 12.00410000 );
        SET_CHAR_HEADING( sub_2572(), 172.00000000 );
        ...
        TASK_PERFORM_SEQUENCE( l_U268, l_U417 );
        CLEAR_SEQUENCE_TASK( l_U417 );
        SET_CAM_BEHIND_PED( sub_2572() );
        GET_GAME_TIMER( ref l_U400 );
    }
    return;
}

void sub_10798(unknown uParam0)
{
    string sVar3;
    ...
    StrCopy( ref g_U9153, uParam0, 32 );
    ...
    g_U9161 = START_NEW_SCRIPT( sVar3, 1024 );
...
void sub_11958(unknown uParam0)
{
    unknown uVar3;
...
void sub_11978(unknown uParam0)
{
    switch (uParam0)
    {
        case 38:
...
void sub_12108()
{
    ...
    iVar2 = 38;
    uVar3 = sub_632( iVar2 );
    sub_12148( ref g_U33969[uVar3]._fU8, 48, 0, 0 );
...
void sub_12148(int iParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
    GET_CURRENT_DATE( (iParam0 + 0) + 0, (iParam0 + 0) + 4 );
    GET_TIME_OF_DAY( (iParam0 + 8) + 0, (iParam0 + 8) + 4 );
    sub_12201( iParam0, uParam1, uParam2 );
    if (NOT bParam3)
    {
        return;
    }
...
void sub_12201(int iParam0, int iParam1, int iParam2)
{
...
void sub_12333(int iParam0)
{
    iParam0->_fU0++;
    if (iParam0->_fU0 > (sub_12364( iParam0->_fU4 )))
    {
        iParam0->_fU0 = 1;
        iParam0->_fU4++;
        if (iParam0->_fU4 > 12)
...
void sub_12805(unknown uParam0)
{
...
void sub_13070()
{
    ...
    switch (g_U33969[uVar3]._fU28)
    {
        ...
        case 2:
        sub_12794( 200 );
        sub_12148( ref g_U33969[uVar3]._fU8, 168, 0, 0 );
        g_U33969[uVar3]._fU24 = 0;
        break;
        case 3:
        sub_12794( 500 );
...
void sub_13697()
{
    ...
    iVar2 = 41;
    uVar3 = sub_632( iVar2 );
    sub_12148( ref g_U33969[uVar3]._fU8, 24, 0, 0 );
    g_U33969[uVar3]._fU24 = 0;
    switch (g_U33969[uVar3]._fU28)
    {
        case 1:
...
void sub_14617()
{
    ...
    switch (g_U33969[uVar3]._fU28)
    {
        case 1:
        sub_12794( 1000 );
        sub_14704( ref g_U33969[uVar3]._fU8 );
        g_U33969[uVar3]._fU24 = 1;
        break;
        case 2:
        sub_12794( 5000 );
        sub_12148( ref g_U33969[uVar3]._fU8, 96, 0, 0 );
        g_U33969[uVar3]._fU24 = 0;
        break;
        case 3: break;
...
void sub_15952(unknown uParam0)
{
    unknown uVar3;

    uVar3 = sub_632( uParam0 );
    g_U33969[uVar3]._fU28 = 99;
    g_U33969[uVar3]._fU4 = 0;
    sub_8127( ref g_U33969[uVar3]._fU8 );
    g_U33969[uVar3]._fU24 = 0;
    sub_16033( uParam0 );
    return;
}

void sub_16033(unknown uParam0)
{
    int iVar3;
    int iVar4;
    ...
    return;
    iVar4 = 0;
    if (NOT g_U64769[iVar3]._fU0)
    {
        iVar4 = g_U64769[iVar3]._fU8;
        if (iVar4 > 0)
        {
            sub_16312( 5, iVar4 );
            g_U64769[iVar3]._fU0 = 1;
            return;
        }
    }
    return;
...
void sub_16312(unknown uParam0, int iParam1)
{
...
void sub_16494(boolean bParam0)
{
    float fVar3;
    float fVar4;
    float fVar5;
...
int sub_17069(unknown uParam0, int iParam1)
{
    ...
    switch (l_U218)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U271 )))
        {
            if (NOT (IS_CAR_DEAD( l_U273 )))
            {
                ...
                if (l_U420 == 7)
                {
                    N_312012851( l_U268, ref l_U285._fU0, ref l_U285._fU4, ref l_U285._fU8 );
                ...
                switch (l_U409)
                {
                    ...
                    if (l_U420 == 1)
                    {
                        ...
                        if (l_U401 > 1)
                        {
                            ...
                            else if (sub_17069( ref l_U400, 1000 ))
                            {
                                sub_6305( "PIJ_KILL", ref l_U421, 4, 1 );
                                l_U409++;
                            }
                        }
                    }
...
void sub_17482(boolean bParam0)
{
    CLEAR_PRINTS();
    CLEAR_HELP();
    sub_1932( 0 );
    ...
    if (IS_PLAYER_PLAYING( sub_1233() ))
    {
        ...
        if (bParam0)
        {
            CLEAR_CHAR_TASKS( sub_2572() );
        }
        SET_PLAYER_CONTROL( sub_1233(), 1 );
        HIDE_CHAR_WEAPON_FOR_SCRIPTED_CUTSCENE( sub_2572(), 0 );
    }
...
int sub_18145()
{
    if (NOT l_U266)
    {
        switch (l_U219)
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U271 )))
            {
                if ((sub_3120( ref l_U271 )) || (sub_3212( ref l_U271, 22.00000000 )))
                {
                    if (IS_VEH_DRIVEABLE( l_U273 ))
                    {
                        if (NOT (IS_CHAR_SITTING_IN_CAR( sub_2572(), l_U273 )))
                        {
                            sub_1932( 0 );
                            SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U271, 1 );
                            OPEN_SEQUENCE_TASK( ref l_U418 );
                            TASK_ENTER_CAR_AS_DRIVER( 0, l_U273, -1 );
                            TASK_CAR_MISSION_PED_TARGET( 0, l_U273, sub_2572(), 8, 25, 2, 200, -1 );
                            CLOSE_SEQUENCE_TASK( l_U418 );
                            TASK_PERFORM_SEQUENCE( l_U271, l_U418 );
                            CLEAR_SEQUENCE_TASK( l_U418 );
                            l_U219 = 1;
                ...
                {
                    if (IS_CHAR_SITTING_IN_CAR( sub_2572(), l_U273 ))
                    {
                        sub_18418( ref l_U271 );
                        return 1;
                    }
...
void sub_18418(unknown uParam0)
{
    if (NOT (IS_CHAR_INJURED( l_U271 )))
    {
        sub_1932( 0 );
        SET_CHAR_KEEP_TASK( l_U271, 1 );
        TASK_SMART_FLEE_CHAR( l_U271, sub_2572(), 100.00000000, -1 );
        l_U266 = 1;
    }
    return;
}

int sub_19025(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
