...
boolean sub_434(unknown uParam0, int iParam1)
{
    ...
    {
        if (sub_755( g_U33969[uVar4]._fU8 ))
        {
...
void sub_1232(int iParam0)
{
    ...
    for ( I = 0; I <= 1; I++ )
    {
        if ((I == iParam0) || (iParam0 == 2))
        {
            ...
            g_U9162._fU148[I] = 0;
            g_U9162._fU112[I] = -1;
            StrCopy( ref g_U9162._fU28[I], "", 16 );
        }
    }
    return;
}
...
void sub_1270(int iParam0)
{
    if (iParam0 == 0)
    {
        CLEAR_THIS_PRINT( ref g_U9162._fU64[0] );
    }
    else
    {
        sub_1322( ref g_U9162._fU64[1] );
    }
    return;
}
...
void sub_5301(unknown uParam0, unknown uParam1)
{
    ...
    sub_5664();
    sub_6431( g_U33969[uVar4]._fU32 );
    g_U33969[uVar4]._fU32 = 0;
    sub_6575( uParam0, uParam1 );
    g_U10899 = 1;
    return;
}
...
void sub_6575(unknown uParam0, int iParam1)
{
    char[16] cVar4;
    int iVar8;
...
void sub_7421(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
...
void sub_7736()
{
    if ((IS_CHAR_DEAD( l_U127 )) AND (NOT (l_U107 == 21)))
    {
        ...
        sub_7799( ref l_U166, 0 );
        sub_7799( ref l_U178, 0 );
        sub_7799( ref l_U190, 0 );
        sub_7799( ref l_U196, 0 );
        sub_7799( ref l_U202, 0 );
        sub_7972( 49, l_U127, 28 );
        sub_8022();
    }
    if (IS_CHAR_IN_ANY_CAR( sub_2049() ))
    {
            ...
            if (IS_VEH_DRIVEABLE( l_U131 ))
            {
                if (IS_CHAR_IN_CAR( sub_2049(), l_U131 ))
                {
                    if (NOT (IS_CHAR_DEAD( l_U127 )))
                    {
                            ...
                            if (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())
                            {
                                if (g_U64658 == 0)
                                {
                                    if (l_U156 == 1)
                                    {
                                        if (sub_9237( l_U166 ))
                                        {
                                            sub_9283( "PML_BANT1V1", ref l_U166, 6, 1 );
                                        }
                                    }
                                    if (l_U156 == 2)
                                    {
                                        if (sub_9237( l_U166 ))
                                        {
                                            sub_9283( "PML_BANT2V1", ref l_U166, 6, 1 );
                                        }
                                    }
                                }
                                else if (g_U64658 == 1)
                                {
                                    if (l_U156 == 1)
                                    {
                                        if (sub_9237( l_U166 ))
                                        {
                                            sub_9283( "PML_BANT1V2", ref l_U166, 6, 1 );
                                        }
                                    }
                                    if (l_U156 == 2)
                                    {
                        ...
                        else if (sub_10454( l_U166 ))
                        {
                            sub_10625( ref l_U166 );
                        }
                    }
                }
    ...
    switch (l_U107)
    {
        ...
        sub_12424( "PMLAUD" );
        sub_12543( 0, sub_2049(), "NIKO", 0 );
        sub_12543( 1, l_U127, "PI_MEL", 0 );
        ...
        if (NOT (IS_CHAR_DEAD( l_U127 )))
        {
            ...
            if (NOT l_U117)
            {
                sub_13062( "PML_N2GO", ref l_U202, 6, 1 );
                WAIT( 250 );
                l_U117 = 1;
            }
        }
        ...
        if (l_U116)
        {
            if (NOT l_U117)
            {
                ...
                if (NOT IS_MESSAGE_BEING_DISPLAYED())
                {
                    if (g_U64658 == 0)
                    {
                        sub_13062( "PML_BANT1V1", ref l_U166, 6, 1 );
                        WAIT( 250 );
                        l_U117 = 1;
                    }
                    else if (g_U64658 == 1)
                    {
                        sub_13062( "PML_BANT1V2", ref l_U166, 6, 1 );
                        WAIT( 250 );
                        l_U117 = 1;
                    }
                    else if (g_U64658 == 2)
        ...
        if (NOT l_U121)
        {
            sub_13062( "PML_LOCATE", ref l_U184, 6, 1 );
            WAIT( 250 );
            if (NOT (IS_CHAR_DEAD( l_U127 )))
            {
        ...
        if (NOT l_U118)
        {
            ...
            sub_12543( 2, l_U128, "LOANSHARK", 0 );
        ...
        switch (l_U102)
        {
            ...
            if (NOT (IS_CHAR_DEAD( sub_2049() )))
            {
                ...
                sub_13062( "PML_LSHARK", ref l_U172, 6, 1 );
            }
            if (NOT (IS_CHAR_DEAD( l_U127 )))
            {
        ...
        if (sub_3420() < 20)
        {
            if (NOT (IS_CHAR_INJURED( l_U127 )))
            {
                if (l_U228)
                {
                    if (NOT (sub_10454( l_U178 )))
                    {
                        GENERATE_RANDOM_INT_IN_RANGE( l_U158, l_U157, ref l_U160 );
                        if (l_U160 > 500)
                        {
                            sub_13062( "PML_COWERS", ref l_U178, 6, 1 );
                            WAIT( 250 );
                            SETTIMERA( 0 );
                            l_U228 = 0;
                        }
                        ...
                        {
                            sub_13062( "PML_ATTK", ref l_U178, 6, 1 );
                            WAIT( 250 );
                            SETTIMERA( 0 );
                            l_U228 = 0;
                        }
                ...
                else if ((TIMERA() > 4500) AND (NOT (sub_10454( l_U178 ))))
                {
        ...
        if (NOT (IS_GROUP_MEMBER( l_U127, sub_5238() )))
        {
            if (sub_3420() < 10.00000000)
            {
                ...
                l_U123 = 1;
                sub_13062( "PML_KILLSH", ref l_U190, 6, 1 );
                WAIT( 1000 );
            }
        }
        else if (sub_15356( ref l_U190 ))
        {
            l_U107 = 16;
        }
        break;
        case 16:
        if ((sub_15356( ref l_U190 )) || (NOT (sub_10454( l_U190 ))))
        {
            l_U107 = 17;
        }
        break;
        ...
        if (NOT l_U124)
        {
            if ((sub_15356( ref l_U190 )) || (NOT (sub_10454( l_U190 ))))
            {
                sub_13062( "PML_TA", ref l_U196, 6, 1 );
                WAIT( 1000 );
                l_U116 = 0;
                l_U117 = 0;
                l_U121 = 0;
        ...
        if (l_U116)
        {
            if (NOT l_U117)
            {
                if (sub_13062( "PML_BANT2V1", ref l_U166, 6, 1 ))
                {
                    l_U117 = 1;
                }
            }
        ...
        if (NOT l_U121)
        {
            ...
            sub_13062( "PML_BACK2S", ref l_U208, 6, 1 );
            WAIT( 250 );
            l_U121 = 1;
        }
        if (NOT (sub_10454( l_U208 )))
        {
            if (NOT (IS_CHAR_DEAD( l_U127 )))
            {
                if (NOT l_U115)
...
void sub_7799(int iParam0, unknown uParam1)
{
    PRINTSTRING( "\n KILL SPEECH CALLED***************************************" );
...
void sub_7972(unknown uParam0, unknown uParam1, unknown uParam2)
{
...
void sub_9237(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
...
{
    return sub_9304( uParam0, ref l_U0._fU0, uParam1, uParam2, uParam3 );
}

int sub_9304(unknown uParam0, unknown uParam1, int iParam2, unknown uParam3, unknown uParam4)
{
    char[16] cVar7;
    char[12] cVar11;
    unknown uVar14;
    ...
    if (iParam2->_fU12)
    {
        ...
        return sub_9368( ref cVar11, iParam2, uParam3, 1, 0, 0, 0, ref cVar7, uParam4 );
    }
    return 0;
}

int sub_9368(unknown uParam0, int iParam1, unknown uParam2, boolean bParam3, boolean bParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8)
{
    int I;
    int iVar12;
    ...
    g_U8419 = {(iParam1^)};
    sub_10076( ref g_U8321, ref l_U0 );
...
void sub_9467(unknown uParam0)
{
    return;
}

void sub_10076(int iParam0, int iParam1)
{
    int I;
...
int sub_10454(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
...
void sub_10765(unknown uParam0)
{
    return;
}
...
void sub_12543(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    sub_12623( "\n PED NUMBER ", uParam0 );
    sub_12663( " ADDED WITH VOICE ", uParam2 );
    return;
}

void sub_12623(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_12663(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_13062(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    return sub_13083( uParam0, ref l_U0._fU0, uParam1, uParam2, uParam3 );
}

void sub_13083(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    char[16] cVar7;
    char[12] cVar11;
    unknown uVar14;
    ...
    StrCopy( ref cVar11[0], uParam0, 16 );
    StrCopy( ref cVar11[1], "END", 16 );
    return sub_9368( ref cVar11, uParam2, uParam3, 0, 0, 0, 0, ref cVar7, uParam4 );
}
...
void sub_15464(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    int Result;

    Result = -1;
    if (sub_10454( uParam0 ))
    {
...
void sub_23537(unknown uParam0)
{
    unknown uVar3;
...
void sub_23687()
{
    ...
    iVar2 = 38;
    uVar3 = sub_478( iVar2 );
    sub_23727( ref g_U33969[uVar3]._fU8, 48, 0, 0 );
...
void sub_23727(int iParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
    GET_CURRENT_DATE( (iParam0 + 0) + 0, (iParam0 + 0) + 4 );
    GET_TIME_OF_DAY( (iParam0 + 8) + 0, (iParam0 + 8) + 4 );
    sub_23780( iParam0, uParam1, uParam2 );
    if (NOT bParam3)
    {
        return;
    }
...
void sub_23780(int iParam0, int iParam1, int iParam2)
{
...
void sub_23912(int iParam0)
{
    iParam0->_fU0++;
    if (iParam0->_fU0 > (sub_23943( iParam0->_fU4 )))
    {
        iParam0->_fU0 = 1;
        iParam0->_fU4++;
        if (iParam0->_fU4 > 12)
...
void sub_24373(unknown uParam0)
{
    sub_24384( uParam0 );
    return;
}
...
void sub_24649()
{
    ...
    switch (g_U33969[uVar3]._fU28)
    {
        ...
        case 2:
        sub_24373( 200 );
        sub_23727( ref g_U33969[uVar3]._fU8, 168, 0, 0 );
        g_U33969[uVar3]._fU24 = 0;
        break;
        case 3:
        sub_24373( 500 );
...
void sub_25276()
{
    ...
    iVar2 = 41;
    uVar3 = sub_478( iVar2 );
    sub_23727( ref g_U33969[uVar3]._fU8, 24, 0, 0 );
    g_U33969[uVar3]._fU24 = 0;
    switch (g_U33969[uVar3]._fU28)
    {
        case 1:
...
void sub_26196()
{
    ...
    switch (g_U33969[uVar3]._fU28)
    {
        case 1:
        sub_24373( 1000 );
        sub_26283( ref g_U33969[uVar3]._fU8 );
        g_U33969[uVar3]._fU24 = 1;
        break;
        case 2:
        sub_24373( 5000 );
        sub_23727( ref g_U33969[uVar3]._fU8, 96, 0, 0 );
        g_U33969[uVar3]._fU24 = 0;
        break;
        case 3: break;
...
void sub_27531(unknown uParam0)
{
    ...
    sub_5776( ref g_U33969[uVar3]._fU8 );
    g_U33969[uVar3]._fU24 = 0;
    sub_27612( uParam0 );
    return;
}
...
void sub_27891(unknown uParam0, int iParam1)
{
...
void sub_28073(boolean bParam0)
{
    float fVar3;
    float fVar4;
    float fVar5;
