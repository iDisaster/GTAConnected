        ...
        if ((NOT g_U8595) AND (g_U748))
        {
            if ((NOT g_U9814._fU12) AND (NOT g_U10899))
            {
                if (NOT l_U4)
                {
                    ...
                    {
                        if ((NOT g_U9814._fU12) AND ((NOT g_U10899) AND (sub_158())))
                        {
                            g_U10899 = 1;
                            l_U4 = 1;
                            sub_543();
                ...
                else if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "sixAxisTutorial" )) == 0) AND (NOT g_U10899))
                {
                    l_U4 = 0;
                    g_U748 = 0;
                    g_U749 = 1;
...
int sub_917(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    switch (uParam0)
    {
        case 0:
