void main()
{
    ...
    while (true)
    {
        ...
        if (l_U239)
        {
            sub_11238( ref l_U288 );
            if (sub_11395( ref l_U280 ))
            {
                CLEAR_PRINTS();
            ...
            switch (l_U215)
            {
                ...
                sub_20392();
                if ((sub_20672( ref l_U286 )) > 200)
                {
                    CLEAR_PRINTS();
                    PRINT( "JEF2_PMT14", 7500, 1 );
                    sub_11481();
                }
                sub_20896( ref l_U286, "JEF2_PMT16" );
                sub_21442( l_U293, ref l_U294, ref l_U324, "JEF2_PMT16", "JEF2_PMT6", ref l_U279, 0, 0.00000000, 0.00000000, 0.00000000, 0.00000000 );
                sub_21655();
                break;
            }
...
void sub_635()
{
    ...
    if (NOT l_U269)
    {
        if (HAS_SCRIPT_LOADED( "jeff_2" ))
        {
            if (l_U270)
            {
                sub_2017( ref g_U64957, 24, 0, l_U262 );
            }
            sub_2628( "jeff_2", 0 );
        }
    }
...
{
    if (NOT g_U34096._fU4)
    {
        return 0;
    }
    if (NOT (g_U34096._fU8 == iParam0))
    {
        return 0;
    }
    if (NOT (g_U34096._fU12 == iParam1))
    {
        return 0;
    }
    return 1;
...
void sub_959()
{
    if (COMPARE_STRING( ref g_U9847, "RIPASS" ))
    {
...
void sub_2017(int iParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
    GET_CURRENT_DATE( (iParam0 + 0) + 0, (iParam0 + 0) + 4 );
    GET_TIME_OF_DAY( (iParam0 + 8) + 0, (iParam0 + 8) + 4 );
    sub_2070( iParam0, uParam1, uParam2 );
    if (NOT bParam3)
    {
        return;
    }
...
void sub_2070(int iParam0, int iParam1, int iParam2)
{
...
void sub_2202(int iParam0)
{
    iParam0->_fU0++;
    if (iParam0->_fU0 > (sub_2233( iParam0->_fU4 )))
    {
        iParam0->_fU0 = 1;
        iParam0->_fU4++;
        if (iParam0->_fU4 > 12)
...
void sub_2628(unknown uParam0, boolean bParam1)
{
...
void sub_2847()
{
    switch (l_U212)
    {
        ...
        if (NOT g_U64961)
        {
            sub_2017( ref g_U64957, g_U64955, 0, l_U262 );
            g_U64961 = 1;
        }
        ...
        break;
        case 1:
        if (sub_2980( g_U64957 ))
        {
            ;
        }
        while (NOT (sub_2980( g_U64957 )))
        {
            WAIT( 0 );
        }
        sub_3262();
...
int sub_2980(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;
    int iVar7;
    int iVar8;
    ...
    if (sub_3149( iVar6, iVar7, uParam0._fU0._fU0, uParam0._fU0._fU4, 180 ))
    {
        return 1;
    }
    return 0;
...
int sub_3149(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, int iParam4)
{
    int iVar7;
...
void sub_3262()
{
    ...
    {
        case 0:
        if (sub_3308( ref l_U401, l_U425 ))
        {
            if (IS_CHAR_ON_FOOT( sub_1302() ))
            {
                if ((sub_3389( sub_1302(), ref l_U330 )) > 150.00000000)
                {
                    sub_3505();
                }
            }
            else if ((sub_3389( sub_1302(), ref l_U330 )) > 300.00000000)
            {
                sub_3505();
            }
        }
        ...
        {
            if ((NOT sub_8469()) || (l_U417 >= 4))
            {
                if (sub_3580( l_U437, l_U400 ))
                {
                    l_U259 = 0;
                    SET_MISSION_FLAG( 1 );
                    sub_8551( l_U437, l_U400 );
                    l_U239 = 1;
                    sub_10853( "WI_JEF2", 0 );
                    CLEAR_PRINTS();
...
int sub_3308(unknown uParam0, int iParam1)
{
...
float sub_3389(unknown uParam0, int iParam1)
{
    float Result;
    unknown uVar5;
    unknown uVar6;
...
void sub_3505()
{
    if ((sub_3524( l_U437, l_U400 )) || (l_U274))
    {
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1204(), 0 )))
        {
            if (sub_4016( 46, "PIJ_MEET", "PIJAUD", 10000, 0 ))
            {
                if (NOT l_U264)
                {
                    sub_7825( "PIJAUD" );
                    sub_7944( 0, sub_1302(), "NIKO", 0 );
                    l_U264 = 1;
                }
                l_U417 = -1;
                l_U259 = 1;
...
void sub_3524(unknown uParam0, unknown uParam1)
{
    if (sub_3533())
    {
        return 0;
    }
    return sub_3580( uParam0, uParam1 );
}
...
boolean sub_3580(unknown uParam0, int iParam1)
{
    unknown uVar4;
    ...
    if (NOT g_U33969[uVar4]._fU24)
    {
        if (sub_2980( g_U33969[uVar4]._fU8 ))
        {
            g_U33969[uVar4]._fU24 = 1;
        }
    }
    if (NOT g_U33969[uVar4]._fU24)
    {
    ...
    return g_U33969[uVar4]._fU28 == iParam1;
}

int sub_3624(unknown uParam0)
{
    int iVar3;

    if (NOT (sub_3635( uParam0 )))
    {
...
void sub_4016(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    char[12] cVar7;
    unknown uVar10;
    unknown uVar11;
    ...
    array(ref uVar16, 2);
    return sub_4076( uParam0, ref cVar7, uParam2, 0, ref uVar16, ref uVar16, "", uParam3, 1, 0, 1, 0, 0, uParam4 );
}

int sub_4076(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    int I;
    ...
    {
        case 0:
        if ((NOT sub_4601()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U18._fU60 = uParam0;
    ...
    sub_5923( uParam0, ref g_U18._fU176 );
    sub_7302( ref g_U18._fU160 );
...
void sub_5923(int iParam0, unknown uParam1)
{
    switch (iParam0)
    {
        case 0:
...
void sub_7302(unknown uParam0)
{
    StrCopy( (uParam0^), "NIKO", 16 );
    return;
}

void sub_7530(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_7825(unknown uParam0)
{
...
void sub_7944(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    sub_8024( "\n PED NUMBER ", uParam0 );
    sub_7530( " ADDED WITH VOICE ", uParam2 );
    return;
}
...
void sub_8551(unknown uParam0, unknown uParam1)
{
    unknown uVar4;
    ...
    if (g_U0)
    {
        g_U33969[uVar4]._fU0 = 1;
        g_U33969[uVar4]._fU4 = 1;
        g_U33969[uVar4]._fU28 = uParam1;
    }
    if (NOT g_U33969[uVar4]._fU0)
    {
    ...
    g_U34096._fU4 = 1;
    g_U34096._fU8 = uParam0;
    g_U34096._fU12 = uParam1;
    sub_8914();
    sub_9681( g_U33969[uVar4]._fU32 );
    g_U33969[uVar4]._fU32 = 0;
    sub_9825( uParam0, uParam1 );
    g_U10899 = 1;
    return;
}
...
int sub_9113(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    switch (uParam0)
    {
        case 0:
...
void sub_9681(int iParam0)
{
    g_U34096._fU16._fU4 += iParam0;
    sub_9715();
...
void sub_9715()
{
    ...
    if (g_U34096._fU16._fU4 < g_U34096._fU16._fU0)
    {
        return;
    }
...
void sub_9825(unknown uParam0, int iParam1)
{
    char[16] cVar4;
    int iVar8;
...
void sub_10671(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
...
void sub_10853(unknown uParam0, unknown uParam1)
{
    boolean bVar4;
...
void sub_11238(unknown uParam0)
{
    int iVar3;

    if (sub_11248( ref iVar3 ))
    {
...
void sub_13185()
{
    switch (l_U221)
    {
        ...
        if (NOT l_U277)
        {
            sub_13295( ref l_U296, ref l_U296, ref l_U363, "JEF2_PMT4", "JEF2_PMT17", ref l_U278, 0, 0.00000000, 0.00000000, 0.00000000, 0.00000000 );
        }
        else
        {
            sub_13295( ref l_U292, ref l_U292, ref l_U366, "JEF2_PMT4", "JEF2_PMT17", ref l_U278, 0, 0.00000000, 0.00000000, 0.00000000, 0.00000000 );
        }
        ...
        if ((sub_13839( ref l_U286, 1000 )) || (sub_13971( ref l_U280 )))
        {
            CLEAR_PRINTS();
        ...
        if (NOT IS_SCREEN_FADED_OUT())
        {
            ...
            {
                if ((sub_3308( ref l_U401, 1500 )) || (IS_CHAR_ON_FOOT( sub_1302() )))
                {
...
void sub_13295(unknown uParam0, unknown uParam1, int iParam2, unknown uParam3, unknown uParam4, unknown uParam5, boolean bParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    else if ((uParam5^))
    {
        ...
        if (NOT (DOES_BLIP_EXIST( (uParam0^) )))
        {
            ...
            if (bParam6)
            {
                sub_13465( uParam1, uParam7, uParam10 );
            }
            CLEAR_PRINTS();
...
void sub_13465(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
...
int sub_13839(unknown uParam0, int iParam1)
{
    int iVar4;
...
int sub_14109()
{
    if ((sub_14122( ref l_U280 )) < 8.00000000)
    {
        return 1;
    }
...
int sub_14445(boolean bParam0, boolean bParam1)
{
    unknown uVar4;
    int iVar5;
    float fVar6;
...
void sub_15801(boolean bParam0)
{
    CLEAR_PRINTS();
    CLEAR_HELP();
    sub_1397( 0 );
...
void sub_16097()
{
    ...
    sub_19692( 46, "PIJ_DONE2", "PIJAUD", 0 );
    sub_20282( ref l_U281 );
    l_U269 = 1;
    sub_635();
    return;
}
...
void sub_16363()
{
    ...
    iVar2 = 38;
    uVar3 = sub_3624( iVar2 );
    sub_2017( ref g_U33969[uVar3]._fU8, 48, 0, 0 );
    g_U33969[uVar3]._fU24 = 0;
    switch (g_U33969[uVar3]._fU28)
    {
        case 1:
        sub_16453( 500 );
        break;
...
void sub_16453(unknown uParam0)
{
    sub_16464( uParam0 );
    return;
}

void sub_16464(unknown uParam0)
{
...
void sub_16729()
{
    ...
    switch (g_U33969[uVar3]._fU28)
    {
        ...
        case 2:
        sub_16453( 200 );
        sub_2017( ref g_U33969[uVar3]._fU8, 168, 0, 0 );
        g_U33969[uVar3]._fU24 = 0;
        break;
        case 3:
        sub_16453( 500 );
...
void sub_17356()
{
    ...
    iVar2 = 41;
    uVar3 = sub_3624( iVar2 );
    sub_2017( ref g_U33969[uVar3]._fU8, 24, 0, 0 );
    g_U33969[uVar3]._fU24 = 0;
    switch (g_U33969[uVar3]._fU28)
    {
        case 1:
...
void sub_18276()
{
    ...
    switch (g_U33969[uVar3]._fU28)
    {
        case 1:
        sub_16453( 1000 );
        sub_18363( ref g_U33969[uVar3]._fU8 );
        g_U33969[uVar3]._fU24 = 1;
        break;
        case 2:
        sub_16453( 5000 );
        sub_2017( ref g_U33969[uVar3]._fU8, 96, 0, 0 );
        g_U33969[uVar3]._fU24 = 0;
        break;
        case 3: break;
...
void sub_19692(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    char[12] cVar6;
    unknown uVar9;
    unknown uVar10;
    ...
    sub_19736( uParam0, ref cVar6, uParam2, 10000, uParam3, 0 );
    return;
}

void sub_19736(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;
    unknown uVar9;
    unknown uVar10;
...
float sub_20672(unknown uParam0)
{
    vector vVar3;
    vector vVar6;
    float Result;
...
int sub_20896(unknown uParam0, unknown uParam1)
{
    int I;
    unknown uVar5;
    unknown uVar6;
...
void sub_21442(unknown uParam0, unknown uParam1, int iParam2, unknown uParam3, unknown uParam4, unknown uParam5, boolean bParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    if (IS_WANTED_LEVEL_GREATER( sub_1204(), 0 ))
    {
        if (NOT (uParam5^))
...
void sub_21655()
{
    ...
    sub_21998( ref l_U286, ref l_U293 );
    if (NOT l_U276)
    {
        if (NOT l_U271)
        {
            if ((sub_22515( ref l_U280, ref l_U426 )) || (IS_CHAR_RESPONDING_TO_EVENT( l_U280, 13 )))
            {
                SET_CHAR_KEEP_TASK( l_U280, 1 );
        ...
        if (((sub_14122( ref l_U280 )) > 150.00000000) AND (NOT (IS_CHAR_ON_SCREEN( l_U280 ))))
        {
            sub_20282( ref l_U280 );
    ...
    for ( l_U402 = 0; l_U402 <= 1; l_U402++ )
    {
        if (DOES_CHAR_EXIST( l_U282[l_U402] ))
        {
            ...
            {
                if (((sub_14122( ref l_U282[l_U402] )) > 150.00000000) AND (NOT (IS_CHAR_ON_SCREEN( l_U282[l_U402] ))))
                {
    ...
    if (DOES_VEHICLE_EXIST( l_U290 ))
    {
        ...
        {
            if (((sub_20672( ref l_U290 )) > 150.00000000) AND (NOT (IS_CAR_ON_SCREEN( l_U290 ))))
            {
...
int sub_21998(unknown uParam0, unknown uParam1)
{
    if (IS_VEH_DRIVEABLE( (uParam0^) ))
    {
        if (DOES_BLIP_EXIST( (uParam1^) ))
...
void sub_22515(unknown uParam0, unknown uParam1)
{
    unknown[2] uVar4;

    array(ref uVar4, 2);
    return sub_22534( uParam0, ref uVar4, uParam1, 0 );
}

int sub_22534(unknown uParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
    int I;
    int iVar7;
