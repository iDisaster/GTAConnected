...
void sub_158()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        FREEZE_CHAR_POSITION( sub_262(), 1 );
        SET_CHAR_VISIBLE( sub_262(), 0 );
        SET_CHAR_COLLISION( sub_262(), 0 );
    }
    if (IS_PLAYER_PLAYING( sub_355() ))
    {
        SET_PLAYER_CONTROL( sub_355(), 0 );
    }
    g_U9811 = 1;
    sub_417();
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        if (HAS_CHAR_GOT_WEAPON( sub_262(), 0 ))
        {
            SET_CURRENT_CHAR_WEAPON( sub_262(), 0, 1 );
        }
    }
    if (IS_PLAYER_PLAYING( sub_355() ))
    {
        SET_PLAYER_CONTROL( sub_355(), 0 );
        SET_EVERYONE_IGNORE_PLAYER( sub_355(), 1 );
    }
...
void sub_417()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        ...
        if (NOT (IS_CHAR_DEAD( sub_262() )))
        {
            GET_CHAR_COORDINATES( sub_262(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
        }
...
void sub_775(unknown uParam0)
{
    BEGIN_CAM_COMMANDS( uParam0 );
    return;
}

void sub_823(unknown uParam0, unknown uParam1)
{
    boolean bVar4;
...
void sub_10193(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_10649(unknown uParam0)
{
    ...
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -359.18380000, -150.46880000, 18.43037000 );
    SET_CAM_ROT( l_U597[iVar3], 24.08957000, 0.00000100, -147.24500000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -363.12170000, -216.71130000, 28.33556000 );
    SET_CAM_ROT( l_U597[iVar3], 15.34723000, 0.00000000, 177.01640000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 25, ref l_U596 );
    SET_CAM_SPLINE_DURATION( l_U596, l_U517[uParam0] );
...
void sub_11102(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_11557(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_12319(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_12769(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_14003(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_15441(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_16381(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_16839(unknown uParam0)
{
    int iVar3;
    int I;
...
void sub_17403(unknown uParam0)
{
    int iVar3;
...
void sub_17635()
{
    ...
    if (DOES_CAM_EXIST( l_U596 ))
    {
        if (NOT (IS_CHAR_DEAD( sub_262() )))
        {
            ...
            if (NOT (IS_PED_ATTACHED_TO_OBJECT( sub_262(), l_U697 )))
            {
                if (IS_CHAR_IN_ANY_CAR( sub_262() ))
                {
                    WARP_CHAR_FROM_CAR_TO_COORD( sub_262(), uVar2._fU0, uVar2._fU4, uVar2._fU8 );
                }
                if (NOT (IS_CHAR_IN_ANY_CAR( sub_262() )))
                {
                    ATTACH_PED_TO_OBJECT( sub_262(), l_U697, 0, 0, 0, 0, 0, 0, 0, 0 );
                }
            }
        }
    }
...
void sub_18527(int iParam0, unknown uParam1)
{
...
void sub_18695(unknown uParam0)
{
    return;
}
...
void sub_20085()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        SET_CHAR_HEADING( sub_262(), 305.90000000 );
    }
    sub_1412();
    STOP_CREDITS();
    ...
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        ...
        {
            if (IS_PED_ATTACHED_TO_OBJECT( sub_262(), l_U697 ))
            {
                DETACH_PED( sub_262(), 1 );
            }
    ...
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_262() )))
        {
            SET_CHAR_VISIBLE( sub_262(), 1 );
            SET_CHAR_COLLISION( sub_262(), 1 );
            SET_CHAR_COORDINATES( sub_262(), -639.60390000, -688.59700000, 6.05100000 );
        }
        else
        {
            SET_CHAR_COLLISION( sub_262(), 1 );
            SET_CHAR_VISIBLE( sub_262(), 1 );
            WARP_CHAR_FROM_CAR_TO_COORD( sub_262(), -639.60390000, -688.59700000, 6.05100000 );
        }
        FREEZE_CHAR_POSITION( sub_262(), 1 );
    }
    ...
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        FREEZE_CHAR_POSITION( sub_262(), 0 );
    }
    N_2399393004( 1 );
    FORCE_WIND( -1 );
    sub_20737( ref l_U591 );
    if (NOT (IS_CHAR_DEAD( sub_262() )))
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_262() )))
        {
...
void sub_20737(unknown uParam0)
{
...
void sub_21128(unknown uParam0, unknown uParam1, unknown uParam2)
{
    int iVar5;

    iVar5 = 0;
    sub_21159( iVar5, uParam0, uParam1, uParam2, "Friend_1" );
    return;
}

void sub_21159(int iParam0, boolean bParam1, boolean bParam2, boolean bParam3, unknown uParam4)
{
    int iVar7;
    int iVar8;
    char[64] cVar9;
    ...
    if (NOT (sub_22339( iParam0, iVar7, iVar25, bParam1, bParam2, bParam3 )))
    {
        return;
    }
    if (bParam2)
    ...
    {
        SET_PLAYER_MOOD_PISSED_OFF( sub_355(), 150 );
    }
    else
    {
        SET_PLAYER_MOOD_NORMAL( sub_355() );
    }
    sub_31499();
    bVar27 = true;
    uVar28 = sub_21832( iParam0, iVar7 );
    uVar29 = sub_32135( iParam0 );
    if (bParam1)
    {
        ...
        if (NOT g_U0)
        {
            ...
            if (IS_BIT_SET( g_U26679[uVar28]._fU108, 2 ))
            {
                ...
                sub_32666( 9, ref g_U13312[iParam0]._fU0._fU24 );
                ...
                if (bVar31)
                {
                    sub_33096();
                    g_U9835._fU8 = 1;
                    g_U9835._fU20 = sub_33181( iParam0, iVar7 );
                }
            }
            if (bVar27)
            {
...
void sub_21255(unknown uParam0)
{
...
int sub_21832(int iParam0, int iParam1)
{
    unknown uVar4;
    int iVar5;
    int Result;
    ...
    {
        sub_21906( "Main_Missions: Find_Trigger(): Illegal Strand ID" );
    }
...
void sub_21906(unknown uParam0)
{
    SCRIPT_ASSERT( uParam0 );
    return;
}

void sub_22250(unknown uParam0, unknown uParam1)
{
    int iVar4;
...
int sub_22339(unknown uParam0, unknown uParam1, unknown uParam2, boolean bParam3, unknown uParam4, unknown uParam5)
{
    boolean bVar8;
    unknown uVar9;
    int iVar10;
    ...
    {
        case 0:
        bVar8 = sub_22547( uParam1 );
        break;
        case 1:
        bVar8 = sub_24553( uParam1 );
        break;
        case 2:
        bVar8 = sub_24779( uParam1 );
        break;
        case 3:
        bVar8 = sub_24929( uParam1 );
        break;
        case 4:
        bVar8 = sub_25207( uParam1 );
        break;
        case 5:
        bVar8 = sub_25510( uParam1 );
        break;
        case 6:
        bVar8 = sub_25709( uParam1 );
        break;
        case 7:
        bVar8 = sub_25935( uParam1 );
        break;
        case 8:
        bVar8 = sub_26170( uParam1 );
        break;
        case 9:
        bVar8 = sub_26545( uParam1 );
        break;
        case 10:
        bVar8 = sub_26792( uParam1 );
        break;
        case 11:
        bVar8 = sub_26931( uParam1 );
        break;
        case 12:
        bVar8 = sub_27230( uParam1 );
        break;
        case 13:
        bVar8 = sub_27458( uParam1 );
        break;
        case 14:
        bVar8 = sub_27745( uParam1 );
        break;
        case 15:
        bVar8 = sub_28027( uParam1 );
        break;
        case 16:
        bVar8 = sub_28309( uParam1 );
        break;
        case 17:
        bVar8 = sub_28510( uParam1 );
        break;
        case 18:
        bVar8 = sub_28583( uParam1 );
        break;
        case 19:
        bVar8 = sub_28797( uParam1 );
        break;
        case 20:
        bVar8 = sub_29050( uParam1 );
        break;
        case 21:
        bVar8 = sub_29297( uParam1 );
        break;
        case 22:
        bVar8 = sub_29498( uParam1 );
        break;
        default:
        PRINTSTRING( "Strand ID: " );
        PRINTINT( uParam0 );
        PRINTNL();
        sub_24158( "Flow_Pass_Stats: Flow_Pass_Strand_Mission(): Unknown strand ID." );
    }
    if (NOT bVar8)
    {
        return 0;
    }
    uVar9 = sub_21832( uParam0, uParam1 );
    if (bParam3)
    {
        iVar10 = g_U13312[uParam0]._fU0._fU56;
        if ((NOT (iVar10 == 5)) AND (NOT (iVar10 == 6)))
        {
            sub_29821( uVar9, uParam0 );
        }
    }
    return 1;
}

int sub_22547(unknown uParam0)
{
    int iVar3;
    boolean bVar4;
    ...
    {
        case 0:
        sub_22826( iVar3, 25, 5, 2, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 30, 5, 2, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 0, 5, 0, 0, 0 );
        break;
        case 4:
        sub_22826( iVar3, 50, 5, 2, 0, 0 );
        break;
        case 5:
        sub_22826( iVar3, 100, 5, 2, 0, 0 );
        break;
        case 6:
        sub_22826( iVar3, 150, 5, 2, 0, 0 );
        break;
        case 8:
        sub_22826( iVar3, 0, 5, 2, 0, 0 );
        break;
        case 9:
        sub_22826( iVar3, 0, 5, 2, 0, 0 );
        break;
        ...
        break;
        case 15:
        sub_22826( iVar3, 250000, 5, 2, 0, 0 );
        break;
        case 16:
        sub_22826( iVar3, 0, 0, 0, 0, 0 );
        break;
        case 20:
        if (g_U15575[12])
        {
        ...
        {
            sub_22826( iVar3, 250000, 0, 0, 0, 0 );
        }
        break;
        case 7:
        sub_22826( iVar3, 0, 3, 1, 0, 0 );
        break;
        case 3:
        case 30:
        case 14:
        ...
        case 27:
        case 28:
        sub_22826( iVar3, 0, sub_24036(), sub_24302(), 0, 0 );
        break;
        default:
        sub_24461( "Friend 1", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Friend 1", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
void sub_22826(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, int iParam5)
{
    sub_22837( uParam1 );
    sub_23011( uParam0, 0, uParam2 );
    sub_23011( uParam0, 1, uParam3 );
    sub_23011( uParam0, 2, uParam4 );
    g_U26668[4] += iParam5;
    sub_21069();
    return;
}
...
{
    ADD_SCORE( sub_355(), uParam0 );
    sub_22862( uParam0 );
    return;
}

void sub_22862(int iParam0)
{
    if (g_U0)
    {
        return;
    ...
    if (iParam0 < 0)
    {
        sub_21906( "Flow_Achievements_Increase_Cash_From_Missions: negative cash given. Tell Keith." );
    }
    INCREMENT_INT_STAT_NO_MESSAGE( 93, iParam0 );
    return;
}

void sub_23011(unknown uParam0, int iParam1, int iParam2)
{
...
void sub_23168(unknown uParam0)
{
    if (g_U0)
    {
        return;
...
int sub_24036()
{
    ...
    sub_24158( "Get_TRUST(): Unknown Friend Pass ID" );
    return 0;
}
...
int sub_24302()
{
    ...
    sub_24158( "Get_LIKE(): Unknown Friend Pass ID" );
    return 0;
}

void sub_24461(unknown uParam0, unknown uParam1)
{
    return;
}

int sub_24553(unknown uParam0)
{
    int iVar3;
    boolean bVar4;
    ...
    {
        case 0:
        sub_22826( iVar3, 50, 5, 5, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 100, 5, 5, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 150, 5, 5, 0, 0 );
        break;
        case 3:
        sub_22826( iVar3, 200, 5, 5, 0, 0 );
        break;
        default:
        sub_24461( "Contact 2", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 2", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_24929(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 200, 5, 2, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 250, 5, 2, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 250, 3, 1, 0, 0 );
        break;
        case 3:
        case 4:
        case 5:
        ...
        break;
        default:
        sub_24461( "Friend 4", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Friend 4", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_25207(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 1:
        sub_22826( iVar3, 400, 5, 5, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 500, 5, 5, 0, 0 );
        break;
        case 3:
        sub_22826( iVar3, 600, 5, 5, 0, 0 );
        break;
        case 4:
        sub_22826( iVar3, 700, 5, 5, 0, 0 );
        break;
        case 5:
        sub_22826( iVar3, 0, 5, 5, 0, 0 );
        break;
        ...
        break;
        default:
        sub_24461( "Contact 5", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 5", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_25510(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 1000, 5, 5, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 1100, 5, 5, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 1500, 5, 5, 0, 0 );
        break;
        default:
        sub_24461( "Contact 7", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 7", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_25709(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 1:
        sub_22826( iVar3, 2000, 5, 5, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 2500, 5, 5, 0, 0 );
        break;
        case 3:
        sub_22826( iVar3, 0, 5, 5, 0, 0 );
        break;
        default:
        sub_24461( "Contact 7b", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 7b", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_25935(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 6000, 5, 2, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 6250, 5, 2, 0, 0 );
        break;
        case 2:
        case 3:
        case 4:
        ...
        break;
        default:
        sub_24461( "Friend 8", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Friend 8", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_26170(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 3500, 5, 2, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 3500, 5, 2, 0, 0 );
        break;
        case 4:
        sub_22826( iVar3, 6750, 5, 2, 0, 0 );
        break;
        case 5:
        sub_22826( iVar3, 0, 5, 2, 0, 0 );
        break;
        ...
        break;
        default:
        sub_24461( "Friend 9", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Friend 9", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_26545(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 6500, 5, 5, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 6750, 5, 5, 0, 0 );
        break;
        case 3:
        if (g_U15575[39])
        {
            sub_22826( iVar4, 0, 5, 10, 0, 0 );
        }
        else
        {
            sub_22826( iVar3, 0, 5, 5, 0, 0 );
        ...
        case 2: break;
        default:
        sub_24461( "Contact 10", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar5)
    {
        sub_24461( "Contact 10", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_26931(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        case 2: break;
        default:
        sub_24461( "Contact 12", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 12", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_27230(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 2:
        sub_22826( iVar3, 7000, 5, 5, 0, 0 );
        break;
        case 3:
        sub_22826( iVar3, 7500, 5, 5, 0, 0 );
        break;
        default:
        sub_24461( "Contact 13", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 13", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_27458(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 7500, 5, 2, 0, 5 );
        break;
        case 1:
        sub_22826( iVar3, 8000, 5, 2, 0, 5 );
        break;
        case 3:
        sub_22826( iVar3, 250000, 5, 2, 0, 5 );
        break;
        case 4:
        case 5:
        case 6:
        ...
        case 2: break;
        default:
        sub_24461( "Friend 15", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Friend 15", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_27745(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 8500, 5, 5, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 9000, 5, 5, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 9500, 5, 5, 0, 0 );
        break;
        case 3:
        sub_22826( iVar3, 9500, 5, 5, 0, 0 );
        break;
        ...
        break;
        case 5:
        sub_22826( iVar3, 11000, 5, 5, 0, 0 );
        break;
        default:
        sub_24461( "Contact 16", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 16", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_28027(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 1:
        sub_22826( iVar3, 9250, 5, 5, 0, 0 );
        break;
        case 4:
        sub_22826( iVar3, 9500, 5, 5, 0, 0 );
        break;
        case 6:
        sub_22826( iVar3, 9750, 5, 5, 0, 0 );
        break;
        case 7:
        sub_22826( iVar3, 0, 5, 5, 0, 0 );
        break;
        ...
        case 5: break;
        default:
        sub_24461( "Contact 18", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 18", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_28309(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        default:
        sub_24461( "Contact 19", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 19", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_28583(unknown uParam0)
{
    ...
    {
        case 0:
        sub_22826( iVar3, 6000, 5, 5, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 6250, 5, 5, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 6500, 5, 5, 0, 0 );
        break;
        case 3: break;
        default:
        sub_24461( "Contact 21", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 21", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_28797(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 2:
        sub_22826( iVar3, 10500, 5, 5, 0, 0 );
        break;
        case 3:
        sub_22826( iVar3, 11000, 5, 5, 0, 0 );
        break;
        case 4:
        sub_22826( iVar3, 12000, 5, 5, 0, 0 );
        break;
        case 1:
        sub_22826( iVar3, 0, 3, 3, 0, 0 );
        break;
        default:
        sub_24461( "Contact 22", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 22", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_29050(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 3:
        sub_22826( iVar3, 13000, 5, 5, 0, 0 );
        break;
        case 5:
        sub_22826( iVar3, 14500, 5, 5, 0, 0 );
        break;
        case 4:
        case 0: break;
        default:
        sub_24461( "Contact 24", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 24", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
int sub_29297(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 1:
        sub_22826( iVar3, 13250, 5, 5, 0, 0 );
        break;
        case 2:
        sub_22826( iVar3, 14500, 5, 5, 0, 0 );
        break;
        default:
        sub_24461( "Contact 25", 1 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    if (bVar4)
    {
        sub_24461( "Contact 25", 0 );
        sub_22826( iVar3, 10, 0, 0, 0, 0 );
        return 0;
    }
    return 1;
...
void sub_29821(int iParam0, int iParam1)
{
    if (g_U0)
    {
        return;
...
int sub_29869(int iParam0, int iParam1)
{
    int iVar4;
    boolean bVar5;
    int iVar6;
...
void sub_30009(unknown uParam0, int iParam1)
{
...
void sub_30191(boolean bParam0)
{
    float fVar3;
    float fVar4;
    float fVar5;
...
void sub_30933(unknown uParam0)
{
...
void sub_31499()
{
    ...
    {
        if (((sub_31537( 5, g_U495[I] )) == 1) AND (g_U495[I]._fU20))
        {
            if ((sub_31537( 1, g_U495[I] )) != 0)
            {
                sub_31823( I );
            }
        }
...
int sub_31537(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    switch (uParam0)
    {
        case 0:
...
int sub_32135(unknown uParam0)
{
    ...
    PRINTINT( uParam0 );
    PRINTNL();
    sub_21906( "Flow_public: Return_Contact_From_Strand(): Unknown strand" );
    return 57;
}

void sub_32666(unknown uParam0, unknown uParam1)
{
    sub_32685( uParam0, 0, 0.00000000, uParam1 );
    return;
}
...
int sub_33181(int iParam0, int iParam1)
{
    if (iParam0 == 0)
    {
        if (iParam1 == 20)
...
void sub_33238(unknown uParam0)
{
    sub_33247();
...
void sub_33454(int iParam0, boolean bParam1)
{
    int iVar4;
